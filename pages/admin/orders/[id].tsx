...
import { AirOutlined, AirplaneTicketOutlined, CreditCardOffOutlined, CreditScoreOutlined } from '@mui/icons-material';
...
const OrderPage: NextPage<Props> = ({order}) => {
  ...
  return (
    <AdminLayout title='Resumen de la orden ' subtitle={`OrderId : ${order._id}`} icon={<AirplaneTicketOutlined/>}>
